# -*- coding: utf-8 -*-
"""dental_data_correlation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1f3OC2o7qzLcblymkZjRxBqbnCllSsq4h
"""
...
if __name__ == "__main__":
    ...
    df_data = preprocess_dental_data(usage='01', drop_all_na=True, skipna=False, set_index=True)

print(df_data.columns)
c= ['ANTERIOR_TOOTH_COUNT', 'POSTERIOR_TOOTH_COUNT', 'TOTAL_TOOTH_COUNT',
       ...
       'SERIOUS_01']
drops = ['ANTERIOR_TOOTH_COUNT', 'POSTERIOR_TOOTH_COUNT','ANTERIOR_CARIES_COUNT', 'POSTERIOR_CARIES_COUNT','ANTERIOR_DENTAL_SEALANT_COUNT', 'POSTERIOR_DENTAL_SEALANT_COUNT','OTHER_NON_CARIOUS_ROOT_LESION',
       'ANTERIOR_SIMPLE_01', 'POSTERIOR_SIMPLE_01', 'TOTAL_SIMPLE_01']

df_data = df_data.drop(drops, axis=1)

import seaborn as sns
    import matplotlib.pyplot as plt

    sns.set(style="white", font_scale=1.2)
    # drops =["TOTAL_SIMPLE_01","ANTERIOR_SIMPLE_01","POSTERIOR_SIMPLE_01","OTHER_NON_CARIOUS_ROOT_LESION","ANTERIOR_DENTAL_SEALANT_COUNT","POSTERIOR_DENTAL_SEALANT_COUNT","ANTERIOR_TOOTH_COUNT", 'POSTERIOR_TOOTH_COUNT']
    df_data = df_data.rename(columns = {'SERIOUS_01':'Id'})
    ...
    sns.heatmap(df_data.corr(), mask=mask,annot=True, cmap=cmap,fmt=".2f", center=0,
